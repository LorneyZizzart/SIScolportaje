    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <a><i class="fa fa-circle text-success"></i> Colportor</a>
        </div>
      </div>
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="../view/bodyRegistroLider.php"><i class="fa fa-circle-o"></i> Registrar</a></li>
            <li class="active"><a href="../view/bodyRegistroLider.php"><i class="fa fa-circle-o"></i> Ver</a></li>
