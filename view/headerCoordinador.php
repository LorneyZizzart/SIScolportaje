...
<li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">
                <?php echo ucwords(strtolower($_SESSION['primerNombre'])); ?>
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  //echo strftime('<br>El año es %Y y el mes %B');
                    $fechaActual = getdate();
                    echo $fechaActual['weekday'] .'<br>'. $fechaActual['mday'] .' - '. $fechaActual['month'] . ' - '. $fechaActual['year'];
                   ?></small>                                                                           <!-- FECHA -->
                </p>
              </li>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>
            <?php echo ucwords(strtolower($_SESSION['primerNombre'] .' '. $_SESSION['segundoNombre'])); ?>
          </p>
          <a><i class="fa fa-circle text-success"></i> Coordinador</a>
        </div>
      </div>
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Lider</span>
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="menuCoordinador.php?modo=AsignarZonaLider"><i class="fa fa-circle-o"></i> Asignar Zona</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="bodyregistrolider.php"><i class="fa fa-circle-o"></i> Listar</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="menuCoordinador.php?modo=ViewRegistrarColportor"><i class="fa fa-circle-o"></i> Registrar</a></li>
            <li class="active"><a href="menuCoordinador.php?modo=ListarLibros"><i class="fa fa-circle-o"></i> Listar</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Campaña</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="menuCoordinador.php?modo=ViewRegistrarCampana"><i class="fa fa-circle-o"></i> Registrar</a></li>
            <li class="active"><a href="menuCoordinador.php?modo=ListarCampanas"><i class="fa fa-circle-o"></i> Listar</a></li>
            <li class="active"><a href="menuCoordinador.php?modo=AsignarLibroCampana"><i class="fa fa-circle-o"></i> Asignar Libros</a></li>
          </ul>
        </li>
        <!--COORDINADOR-->
        <li class="treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Coordinador</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
